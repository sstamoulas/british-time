                                          ...
                                          <div className="video-viewer--container--23VX7">
                                             <div className="video-player--container--YDQRW">
                                                <div className="video-player--video-wrapper--1L212 user-activity--user-inactive--2uBeO">
                                                   <link rel="preload" href="https://mp4-b.udemycdn.com/2017-03-22_22-41-19-ab6c6fc1434f4a97331cba8844bb363a/thumb-sprites.jpg?secure=tQk5zwkxrksRvLT8oXOZvQ%3D%3D%2C1606952708" as="image" />
                                                   <div>
                                                      <div className="video-player--center-button--aPLkI">
                                                         <button data-purpose="video-play-button-initial" aria-label="Play video">
                                                            <img height="96" width="96" alt="Play video" tabIndex="0" className="" src="/staticx/udemy/js/webpack/icon-play.ac3f32ecb72a0c3f674fa5a3f3062a56.svg" />
                                                         </button>
                                                      </div>
                                                   </div>
                                                   <div controlsList="nodownload" preload="auto" id="playerId__8036556--3" className="video-js video-player--video-player--1sfof vjs-paused vjs-controls-enabled vjs-workinghover vjs-v6 vjs-user-inactive" lang="en-us" role="region" aria-label="Video Player">
                                                      <video className="vjs-tech" id="playerId__8036556--3_html5_api" preload="auto" controlsList="nodownload" tabIndex="-1" src="blob:https://www.udemy.com/8282896d-2945-49e2-b9a0-d5c349518ceb"></video>
            ...
            <div data-purpose="sidebar">
               ...
               <div className="sidebar--content---4z0-">
                  <div data-purpose="curriculum-section-container">
                     <div className="section--section--BukKG" data-purpose="section-panel-0" aria-expanded="true">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="true">
                           ...
                           <div className="font-text-xs"><span className="mr-space-xxs">6 / 12</span>|<span data-purpose="section-duration" className="ml-space-xxs">50min</span></div>
                        </div>
                        <ul className="section--section-list--1VLOz">
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-0" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Play 1. Introduction. Duration 7min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} checked="" onChange={() => true} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>1. Introduction</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           ...
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-1" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Start Quiz 1: Welcome quiz: Let's get our logic-based thinking warmed up. " location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} checked="" onChange={() => true} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>Quiz 1: Welcome quiz: Let's get our</span><br /><span>logic-based thinking warmed up</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE"></div>
                                 </div>
                              </div>
                           </li>
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-2" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Play 2. Let's code the quiz!. Duration 7min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} checked="" onChange={() => true} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>2. Let's code the quiz!</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                                       <div className="curriculum-item-link--metadata--e17HG"><span className="curriculum-item-link--type--ZeQ8O"><span className="udi udi-play-circle"></span></span><span>7min</span></div>
                                    </div>
                                 </div>
                           ...
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-3" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Play 3. Course Structure, Overview and best way to use the course. Duration 8min" location="[object Object]" tabIndex="0" role="link">
                                 ...
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>3. Course Structure, Overview and best way</span><br /><span>to use the course</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                           ...
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-4" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Play 4. Ruby on Rails Development Environment overview. Duration 2min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} checked="" onChange={() => true} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>4. Ruby on Rails Development Environment</span><br /><span>overview</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                           ...
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-5" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Start 5. [IMPORTANT] Development Environment Update - Please don't skip this text lecture. Duration 1min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} checked="" onChange={() => true} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>5. [IMPORTANT] Development Environment</span><br /><span>Update - Please don't skip this text lecture</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                           ...
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-6" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Start 6. Web apps built in the course - Preview series kickoff. Duration 1min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} checked="" onChange={() => true} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>6. Web apps built in the course - Preview</span><br /><span>series kickoff</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                                       <div className="curriculum-item-link--metadata--e17HG"><span className="curriculum-item-link--type--ZeQ8O"><span className="udi udi-article"></span></span><span>1min</span></div>
                                    </div>
                                 </div>
                           ...
                           <li aria-current="true" className="curriculum-item-link--curriculum-item--KX9MD curriculum-item-link--is-current--31BPo">
                              <div data-purpose="curriculum-item-0-7" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Play 7. Preview: SaaS - Project Management App built in section 11. Duration 11min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>7. Preview: SaaS - Project Management App</span><br /><span>built in section 11</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                                       <div className="curriculum-item-link--metadata--e17HG"><span className="curriculum-item-link--type--ZeQ8O"><span className="udi udi-play-circle"></span></span><span>11min</span></div>
                                    </div>
                                 </div>
                              </div>
                           </li>
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-8" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Play 8. Preview of MessageMe chat application showcasing real-time Rails - Section 8. Duration 3min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>8. Preview of MessageMe chat application</span><br /><span>showcasing real-time Rails - Section 8</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                           ...
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-9" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Play 9. Preview of Finance Tracker App built in section 9, rapid prototyping. Duration 3min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>9. Preview of Finance Tracker App built in</span><br /><span>section 9, rapid prototyping</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                                       <div className="curriculum-item-link--metadata--e17HG"><span className="curriculum-item-link--type--ZeQ8O"><span className="udi udi-play-circle"></span></span><span>3min</span></div>
                                    </div>
                                 </div>
                           ...
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-10" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Play 10. Preview of Univ App using material design for front-end (Section 12). Duration 2min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>10. Preview of Univ App using material design</span><br /><span>for front-end (Section 12)</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                                       <div className="curriculum-item-link--metadata--e17HG"><span className="curriculum-item-link--type--ZeQ8O"><span className="udi udi-play-circle"></span></span><span>2min</span></div>
                                    </div>
                                 </div>
                           ...
                           <li aria-current="false" className="curriculum-item-link--curriculum-item--KX9MD">
                              <div data-purpose="curriculum-item-0-11" className="item-link item-link--common--RP3fp item-link--default-theme--YqsPR" aria-label="Play 11. Preview of Alpha Blog App built from section 4 through 7. Duration 3min" location="[object Object]" tabIndex="0" role="link">
                                 <label className="curriculum-item-link--progress-toggle--1CMcg checkbox-inline" title=""><input data-purpose="progress-toggle-button" aria-label="Lecture completed" type="checkbox" onChange={() => false} /><span className="toggle-control-label checkbox-label"></span></label>
                                 <div className="curriculum-item-link--item-container--1ptOz">
                                    <div className="curriculum-item-link--title--zI5QT"><span width="0"><span><span>11. Preview of Alpha Blog App built from</span><br /><span>section 4 through 7</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                                    <div className="curriculum-item-link--lecture-type-resource-container--2l5ZE">
                                       <div className="curriculum-item-link--metadata--e17HG"><span className="curriculum-item-link--type--ZeQ8O"><span className="udi udi-play-circle"></span></span><span>3min</span></div>
                                    </div>
                                 </div>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-1" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 2: The Ruby Programming</span><br /><span>Language</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                           <div className="font-text-xs"><span className="mr-space-xxs">0 / 42</span>|<span data-purpose="section-duration" className="ml-space-xxs">4hr 24min</span></div>
                        </div>
                     </div>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-3" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 4: CRUD Operations in Ruby on</span><br /><span>Rails</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-4" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 5: Styling for your Rails</span><br /><span>Application</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-5" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 6: Associations and</span><br /><span>Authentication Systems</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-6" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label">
                              <span width="0" aria-labelledby="popper12" tabIndex="0"><span><span>Section 7: Many-To-Many Associations</span><br /><span><span>and Automated Testing - Integration, F…</span></span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span>
                              <div className="sr-only" id="popper12">Section 7: Many-To-Many Associations and Automated Testing - Integration, Functional, Unit</div>
                           </div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-7" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label">
                              <span width="0" aria-labelledby="popper13" tabIndex="0"><span><span>Section 8: Real-time Rails - MessageMe</span><br /><span><span>Chat app using ActionCable and web so…</span></span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span>
                              <div className="sr-only" id="popper13">Section 8: Real-time Rails - MessageMe Chat app using ActionCable and web sockets</div>
                           </div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-8" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 9: Stock Tracker Social Media</span><br /><span>App</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-9" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 10: Email, Custom Payment</span><br /><span>Functionality and File Uploads</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-10" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 11: Software as a Service Project</span><br /><span>Management App</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-11" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 12: Material Design</span><br /><span>(MaterializeCSS) as front-end</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-12" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 13: Rails installation and usage:</span><br /><span>Mac</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-13" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 14: Rails installation and usage:</span><br /><span>AWS Cloud9</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
                     ...
                     <div className="section--section--BukKG" data-purpose="section-panel-14" aria-expanded="false">
                        <div role="button" tabIndex="0" className="section--section-heading--2k6aW" data-purpose="section-heading" aria-expanded="false" >
                           <div className="section--title--eCwjX" data-purpose="section-label"><span width="0"><span><span>Section 15: Rails Installation and usage:</span><br /><span>Windows</span></span><span style={{position: 'fixed', visibility: 'hidden', top: '0px', left: '0px'}}>…</span></span></div>
                           <span aria-hidden="true" className="section--section-chevron--tJ4mD udi udi-angle-down"></span>
